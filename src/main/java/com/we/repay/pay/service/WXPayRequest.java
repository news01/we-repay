...
public class WXPayRequest {
     ...
     * 请求，只请求一次，不做重试
     * @param domain 域名
     * @param urlSuffix 地址后缀
     * @param uuid 随机字符串
     * @param data 数据
     * @param connectTimeoutMs 连接超时时间
     * @param readTimeoutMs 读数据超时时间
