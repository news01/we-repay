...
(function(window,iusp) {
	 ...
	 * 封装post
	 * url : 访问路径
	 * params ：参数，对象 如{id:2,code:'zhangsan'}
	 * fun : 回调方法，function
	 * selfNotice : 自定义提示，如果selfNotice=ture 则不走共同拦截提示
	 */
	 ...
	 * @param win window对象
	 * @param value  number 参数使用的是要访问的 URL 在 History 的 URL 列表中的相对位置。 如：-1 表示返回上一页
